...
physical-basis risk, committed-programme portfolio -- 293 tests; ~129 of
them need the workbook and self-skip without it):
...
CI (`.github/workflows/tests.yml`) runs the pure-test subset (164 tests)
