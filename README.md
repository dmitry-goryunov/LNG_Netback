...
built-in curve, exposure-derived hedges, contract-ID backtest + bootstrap
VaR bands -- 415 tests; ~208 of them need the workbook and self-skip
without it):
...
CI (`.github/workflows/tests.yml`) runs the pure-test subset (207 tests)
