...
built-in curve, exposure-derived hedges -- 385 tests; ~185 of them need
the workbook and self-skip without it):
...
CI (`.github/workflows/tests.yml`) runs the pure-test subset (200 tests)
